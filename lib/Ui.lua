...
function Ui:Init(Data)
	...
	--// ReGui
    ReGui = loadstring(game:HttpGet(`https://raw.githubusercontent.com/myrelune/sigma-spy-restored/refs/heads/main/lib/ReGui.lua`), "ReGui")()
	self:LoadFont()
	self:LoadReGui()
	self:CheckScale()
end
	...
	self:CreateButtons(Tab, {
		...
		Buttons = {
			...
			},
			{
				Text = "Copy Github",
				Callback = function()
					self:SetClipboard("https://github.com/myrelune/sigma-spy-restored")
				end,
			},
			{
				Text = "Edit Spoofs",
